...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   KC_G,              KC_X,              KC_J,              KC_K,              KC_Z,                    KC_Q,       KC_R,              KC_M,              KC_F,              KC_P,              KC_NO,
                                                       LT(2,KC_RALT),     LT(1,KC_BSPC),     LT(3,KC_ESC),            LT(3,KC_ENT), LT(2,KC_SPC),  LT(1,KC_RALT)
    ),
     /*
      * ┌───┬───┬───┬───┬───┬───┐       ┌───┬───┬───┬───┬───┬───┐
      * │   │ ~ │ % │ / │ \ │ ` │       │Tab│ ->│End│ $ │Ins│   │
...
// nav
    [1] = LAYOUT_split_3x6_3(
		...
		KC_NO,   KC_HASH,    KC_AT,     KC_PGDN,     KC_PGUP,    KC_NO,                           S(KC_TAB),   KC_LEFT,   KC_HOME,    KC_CIRC,    KC_RALT,    KC_NO, 
    ...
    [3] = LAYOUT_split_3x6_3(
        KC_NO,   KC_F16,     KC_F15,    KC_F14,      KC_F13,     KC_PSCR,                         KC_NO,       KC_F9,     KC_F10,     KC_F11,     KC_F12,     KC_NO,
		KC_NO,   KC_NO,      KC_NO,     C(KC_Z),     C(KC_Y),    KC_NO,                           KC_NO,       KC_F5,     KC_F6,      KC_F7,      KC_F8,      KC_NO,
		KC_NO,   KC_NO,      C(KC_X),   C(KC_C),     C(KC_V),    KC_NO,                           KC_NO,       KC_F1,     KC_F2,      KC_F3,      KC_F4,      KC_NO, 
		                                KC_TRNS,     KC_TRNS,    KC_TRNS,                         KC_TRNS,     KC_TRNS,   KC_TRNS
    )
};
